...
public:
    /* constructors */
    inline InfInt() : pos(true)
    {
        //PROFINY_SCOPE
        val.push_back((ELEM_TYPE) 0);
    }
    inline InfInt(const char* c)
    {
        //PROFINY_SCOPE
        fromString(c);
    }

    inline InfInt(const std::string& s)
    {
        //PROFINY_SCOPE
        fromString(s);
    }

    inline InfInt(int l) : pos(l >= 0)
    {
        //PROFINY_SCOPE
    ...
    inline InfInt(long long l) : pos(l >= 0)
    {
        //PROFINY_SCOPE
        bool subtractOne = false;
        if (l == LONG_LONG_MIN)
    ...
    inline InfInt(unsigned int l) : pos(true)
    {
        //PROFINY_SCOPE
        do
        {
    ...
    inline InfInt(unsigned long l) : pos(true)
    {
        //PROFINY_SCOPE
        do
        {
    ...
    inline InfInt(unsigned long long l) : pos(true)
    {
        //PROFINY_SCOPE
        do
        {
    ...
    inline InfInt(const InfInt& l) : val(l.val), pos(l.pos)
    {
        //PROFINY_SCOPE
    }
